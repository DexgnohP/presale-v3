...
function Register() {
  ...
  const submitForm = async (value) => {
    ...
    if (!isSolanaWalletAddress(value.country.name === "Vietnam")) {
      notification.error({
        message: `Error`,
        description:
          "This registration form is not valid for use in Vietnam and does not accept users from Vietnam!!!",
        placement: "topRight",
      });
      return;
    }
    ...
    const url =
      "https://zofrlhlhqd.execute-api.ap-southeast-1.amazonaws.com/api/white-list/submit";
    const data = {
      ref: value.ref,
      wallet: value.wallet,
  ...
  return (
    <div className="container-register">
      ...
      <div
        className="text-center font-syne text-2xl font-extrabold uppercase text-white md:text-[50px]"
      ...
      <Form form={form} style={{ marginTop: "30px" }} onFinish={submitForm}>
        <Form.Item>
          <span style={{ zIndex: "12312", color: "white", margin: "0 20%" }}>
            Note: This registration form is not valid for use in Vietnam and
            does not accept users from Vietnam
          </span>
        </Form.Item>
        <Form.Item
          ...
          <Tooltip
            ...
            title={
              ...
              >
                ...
                <br />
                These terms and conditions ("Terms", "Terms of Use") govern your
                use of IDOSOL and any related services provided by IDOSOL ("us",
                "we", or "our"). By accessing or using IDOSOL, you agree to
                abide by these Terms. If you do not agree to these Terms, please
                refrain from using IDOSOL. <br />
                <br />
                <strong>Disclaimer</strong> <br />
                <br />
                IDOSOL is a company offering services related to token
                transactions. By using IDOSOL, you acknowledge and agree that we
                do not allow individuals residing in Vietnam to access or use
                our services. We explicitly disclaim any responsibility for
                buyers or sellers located within Vietnam.
                <br />
                <br />
                <strong>Use of IDOSOL</strong>
                <br />
                <br />
                You agree to use IDOSOL solely for its intended purpose of token
                transactions in jurisdictions where such activities are legal.
                You further agree not to use IDOSOL for any unlawful or
                fraudulent activities. <br />
                <br />
                <strong>Intellectual Property</strong>
                <br />
                <br />
                All intellectual property rights related to IDOSOL, including
                but not limited to trademarks, copyrights, and patents, are
                owned by IDOSOL. You agree not to reproduce, distribute, or
                create derivative works based on IDOSOL without prior written
                consent from IDOSOL.
                <br />
                <br />
                <strong>Limitation of Liability</strong>
                <br />
                <br /> To the fullest extent permitted by law, IDOSOL shall not
                be liable for any direct, indirect, incidental, special, or
                consequential damages arising out of or in any way connected
                with your use of IDOSOL. This includes but is not limited to
                ...
                <br />
                <br /> IDOSOL reserves the right to modify or replace these
      ...
      <Table
        style={{ margin: "0 50px", overflow: "scroll" }}
        pagination={{
          pageSize: 10,
